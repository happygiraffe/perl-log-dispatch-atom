...
sub test_basics {
    my $fn = tempfilename();
    my $log = Log::Dispatch::Atom->new( file => $fn );
    ...
    is( $entries[0]->content->body, 'hello world', 'log(1) made correct content' );

    $log->log( message => 'hello world#2' );
    ...
    is( $entries[0]->content->body, 'hello world#2', 'log(2) made correct content' );
    return;
}
